    ...
    $.fn.pgwSlider = function(options) {
        ...
        var setup = function() {
            ...
            if (pgwSlider.config.displayControls && pgwSlider.slideCount > 1) {
                pgwSlider.plugin.find('.ps-current').prepend('<span  class="ps-prev"><span id="second" class="ps-prevIcon"></span></span>');
                pgwSlider.plugin.find('.ps-current').append('<span  class="ps-next"><span id="third" class="ps-nextIcon"></span></span>');
